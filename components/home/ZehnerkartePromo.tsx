              ...
              <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-10">
                ...
                <div className="flex-1 max-w-xl">
                  ...
                  <h2 className="font-display text-4xl sm:text-5xl lg:text-6xl font-light text-cream mb-4">
                    Zehnerkarte —{" "}
                    <em className="not-italic italic text-gold">10 noches, 100€</em>
                  </h2>
                  <p className="font-sans text-sm text-muted leading-relaxed mb-6 max-w-md">
                    {zehnerkarte.description} Solo{" "}
                    <strong className="text-cream">10€ por noche</strong>. Más del
                    30% de ahorro frente a la taquilla.
                  </p>
